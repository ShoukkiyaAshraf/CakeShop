    ...
    <form id="form" class="splash-container" data-parsley-validate="" method="post" action="insert_admin.php">
        <div class="card">
            <div class="card-header">
                <h3 class="mb-1"><center>Registrations Form</center></h3>
                <p><center>Please enter your user information.</center></p>
            </div>
            <div class="card-body">
                <div class="form-group">
                    <input class="form-control form-control-lg" type="text" name="admin_username" pattern="^[A-Za-z -]+$"  data-parsley-trigger="change" required="" placeholder="Username" autocomplete="off">
                </div>
                <div class="form-group">
